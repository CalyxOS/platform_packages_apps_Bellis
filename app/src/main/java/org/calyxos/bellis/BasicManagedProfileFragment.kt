...
class BasicManagedProfileFragment : Fragment(R.layout.basic_managed_profile_fragment) {
            ...
            return MaterialAlertDialogBuilder(requireContext())
                ...
                .setPositiveButton(android.R.string.ok) { _, _ ->
                    val devicePolicyManager =
                        mContext.getSystemService(DevicePolicyManager::class.java)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.remove_profile)?.setOnClickListener {
            mContext = it.context
            RemoveProfileDialogFragment().show(
                childFragmentManager, RemoveProfileDialogFragment::class.java.simpleName
            )
        }
