...
class BasicDeviceAdminService : DeviceAdminService() {
    ...
    private fun onUpgrade() {
        ...
        val oldVersion = sharedPreferences.getLong("pref_version", -1)
        ...
        sharedPreferences.edit { putLong("pref_version", curVersion) }
    }

    private fun upgradeIfNeeded(oldVersion: Int, newVersion: Int) {
        val currentVersion = oldVersion
